...
1. Сделать запрос для получения атрибутов из указанных таблиц, применив фильтры по указанным условиям:<br>
    ...
    Четвертый план эффективнее: мы уменьшаем размер таблиц до соединения, поэтому само соединение выполняется
    значительно быстрее.
    На практике:
    | Запрос | Результат |
    |---|---|
    ...
    При этом пятый план позволяет уменьшить размер таблиц за счет дополнительных проекций,
    что позволяет сэкономить память.
    Это увеличит время выполнения на маленьких таблицах, но незначительно,
    зато сэкономит время на больших таблицах.
...
1. Сделать запрос для получения атрибутов из указанных таблиц, применив фильтры по указанным условиям:
    ...
    |1|2|3|4|
    |:-:|:-:|:-:|:-:|
    |![](./p21.svg)|![](./p22.svg)|![](./p23.svg)|![](./p24.svg)|
    ...
    При этом третий план позволяет уменьшить размер таблиц за счет дополнительных проекций,
    что позволяет сэкономить память.
    Это увеличит время выполнения на маленьких таблицах, но незначительно,
    зато сэкономит время на больших таблицах.
